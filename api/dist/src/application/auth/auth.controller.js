...
let AuthController = class AuthController {
    ...
    async login(loginDto, res) {
        const { token } = await this.authService.authenticate(loginDto.email, loginDto.password, loginDto.type);
        return res
    ...
    async register(payload, res) {
        const _a = await this.authService.register(payload), { token } = _a, user = __rest(_a, ["token"]);
        return res
            .cookie('access_token', token, {
            httpOnly: true,
            sameSite: 'strict',
