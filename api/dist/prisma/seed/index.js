...
async function main() {
    ...
    const lecturer = await prisma.user.create({
        data: {
            ...
            name: 'Dr. John Doe',
            type: client_1.UserType.LECTURER,
        },
    });
    if (!lecturer.id)
        return null;
    const examsData = [
        {
            ...
            questions: [
                ...
                },
                {
                    ...
                    answer: 'A compiler translates code into machine code all at once, while an interpreter translates code line by line.',
                },
            ],
        },
        {
    ...
    for (const examData of examsData) {
        await prisma.exam.create({
            data: Object.assign(Object.assign({}, examData), { creatorId: lecturer.id, questions: {
